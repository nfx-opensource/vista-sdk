...
namespace dnv::vista::sdk
{
	...
	GmodPathQueryBuilder::Nodes GmodPathQueryBuilder::Nodes::withNode( const GmodNode& node, bool matchAllLocations ) const&
	{
		Nodes copy{ *this };
	...
	GmodPathQueryBuilder::Nodes GmodPathQueryBuilder::Nodes::withNode( const GmodNode& node, const std::vector<Location>& locations ) const&
	{
		Nodes copy{ *this };
