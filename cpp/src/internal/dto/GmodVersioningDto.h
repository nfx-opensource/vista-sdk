...
namespace dnv::vista::sdk
{
	...
	public:
		 ...
		 */
		explicit GmodVersioningAssignmentChangeDto( std::string oldAssignment, std::string currentAssignment ) noexcept;
		 ...
		 */
		[[nodiscard]] std::string_view oldAssignment() const noexcept;
		 ...
		 * @note This function is marked [[nodiscard]] - the return value should not be ignored
		 */
		[[nodiscard]] std::string_view currentAssignment() const noexcept;
	...
	public:
		 ...
		 */
		explicit GmodNodeConversionDto( OperationSet operations, std::string source, std::string target, std::string oldAssignment,
		 ...
		 * @note This function is marked [[nodiscard]] - the return value should not be ignored
		 */
		[[nodiscard]] const OperationSet& operations() const noexcept;
		 ...
		 * @note This function is marked [[nodiscard]] - the return value should not be ignored
		 */
		[[nodiscard]] std::string_view newAssignment() const noexcept;
		 ...
		 * @note This function is marked [[nodiscard]] - the return value should not be ignored
		 */
		[[nodiscard]] bool deleteAssignment() const noexcept;
	...
	public:
		 ...
		 */
		explicit GmodVersioningDto( std::string visVersion, ItemsMap items ) noexcept;
		 ...
		 * @note This function is marked [[nodiscard]] - the return value should not be ignored
		 */
		[[nodiscard]] const ItemsMap& items() const noexcept;
