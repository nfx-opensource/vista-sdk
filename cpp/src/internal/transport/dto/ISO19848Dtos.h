...
namespace dnv::vista::sdk::internal::transport
{
	...
	public:
		 ...
		 */
		explicit DataChannelTypeNameDto( std::string type, std::string description ) noexcept;
	...
	public:
		 ...
		 */
		explicit DataChannelTypeNamesDto( std::vector<DataChannelTypeNameDto> values ) noexcept;
		 ...
		 * @note This function is marked [[nodiscard]] - the return value should not be ignored
		 */
		[[nodiscard]] const std::vector<DataChannelTypeNameDto>& values() const noexcept;
	...
	public:
		 ...
		 * @param description The description of the type
		 */
		explicit FormatDataTypeDto( std::string type, std::string description ) noexcept;
	...
	public:
		 ...
		 */
		explicit FormatDataTypesDto( std::vector<FormatDataTypeDto> values ) noexcept;
		 ...
		 * @note This function is marked [[nodiscard]] - the return value should not be ignored
		 */
		[[nodiscard]] const std::vector<FormatDataTypeDto>& values() const noexcept;
