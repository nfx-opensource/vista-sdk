...
namespace dnv::vista::sdk
{
	...
	namespace internal
	{
		 ...
		 */
		GmodParsePathResult fromShortPath(
			std::string_view,
			const Gmod&,
		 ...
		 * @return GmodParsePathResult containing either the parsed GmodPath or detailed error message
		 */
		GmodParsePathResult fromFullPath(
			std::string_view,
			const Gmod&,
			const Locations& ) noexcept;
	...
	class GmodNode final
	{
		...
		friend internal::GmodParsePathResult internal::fromFullPath( std::string_view, const Gmod&, const Locations& ) noexcept;
	...
	private:
		 ...
		 */
		GmodNode withLocation( const Location& location ) const noexcept;
