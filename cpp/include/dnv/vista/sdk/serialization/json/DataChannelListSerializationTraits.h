...
namespace nfx::serialization::json
{
	...
	public:
		...
		static void serialize( const dnv::vista::sdk::transport::datachannel::DataChannelListPackage& obj, Document& doc )
		{
			...
			doc.set( "/Package/Header/DataChannelListID/TimeStamp", configRef.timeStamp().toString( DateTime::Format::Iso8601Precise ) );
			...
			{
				doc.set( "/Package/Header/DateCreated", dateCreated->toString( DateTime::Format::Iso8601Precise ) );
			}
