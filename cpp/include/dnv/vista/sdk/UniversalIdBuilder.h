...
namespace dnv::vista::sdk
{
	...
	public:
		 ...
		 * @param universalIdStr String representation of UniversalId (e.g., "data.dnv.com/IMO1234567/dnv-v2/vis-3-4a/621.21/S90/sec/411.1/C101/meta/qty-mass/cnt-fuel.oil/pos-inlet")
	...
	private:
		static std::optional<UniversalId> fromString( std::string_view universalIdStr, ParsingErrors* outErrors ) noexcept;
