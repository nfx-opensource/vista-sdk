...
namespace dnv::vista::sdk
{
	...
	class Gmod final
	{
		...
		friend internal::GmodParsePathResult internal::fromShortPath( std::string_view, const Gmod&, const Locations& ) noexcept;
	...
	private:
		 ...
		 */
		[[nodiscard]] static inline bool isProductTypeAssignment( const GmodNode* parent, const GmodNode* child ) noexcept;
		 ...
		 */
		[[nodiscard]] static inline bool isProductSelectionAssignment( const GmodNode* parent, const GmodNode* child ) noexcept;
		 ...
		 */
		[[nodiscard]] static inline constexpr bool isPotentialParent( std::string_view type ) noexcept;
	...
	private:
		...
		ChdDictionary<std::string, GmodNode> m_nodeMap; ///< All nodes indexed by code (owns all nodes, transparent hash)
