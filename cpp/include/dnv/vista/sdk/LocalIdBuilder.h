...
namespace dnv::vista::sdk
{
	...
	public:
		...
		[[nodiscard]] static inline constexpr std::string_view namingRule() noexcept;
		 ...
		 */
		[[nodiscard]] inline LocalIdBuilder withVisVersion( VisVersion version ) const& noexcept;
		 ...
		 */
		[[nodiscard]] inline LocalIdBuilder withoutVisVersion() const& noexcept;
		 ...
		 */
		[[nodiscard]] inline LocalIdBuilder withoutPrimaryItem() const& noexcept;
		 ...
		 */
		[[nodiscard]] inline LocalIdBuilder withoutSecondaryItem() const& noexcept;
		 ...
		 */
		[[nodiscard]] inline LocalIdBuilder withoutMetadataTag( CodebookName name ) const& noexcept;
		 ...
		 */
		[[nodiscard]] inline LocalIdBuilder withVerboseMode( bool verbose ) const& noexcept;
	...
	private:
		static std::optional<LocalId> fromString(
			...
			internal::LocalIdParsingErrorBuilder* errorBuilder ) noexcept;
