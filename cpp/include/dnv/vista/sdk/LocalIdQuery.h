...
namespace dnv::vista::sdk
{
	...
	public:
		 ...
		 * @return New builder with tags set
		 */
		[[nodiscard]] inline LocalIdQueryBuilder withTags( std::function<MetadataTagsQuery( MetadataTagsQueryBuilder& )> configure ) const&;
		 ...
		 * @return This builder with tags set
		 */
		[[nodiscard]] inline LocalIdQueryBuilder withTags( std::function<MetadataTagsQuery( MetadataTagsQueryBuilder& )> configure ) &&;
