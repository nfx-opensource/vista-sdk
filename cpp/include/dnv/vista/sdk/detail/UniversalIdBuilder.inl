...
namespace dnv::vista::sdk
{
	...
	inline UniversalIdBuilder UniversalIdBuilder::withLocalId( const std::optional<LocalIdBuilder>& localIdBuilder ) const&
	{
	...
	inline void UniversalIdBuilder::toString( StringBuilder& sb ) const
	{
		...
		sb << iso19848::annexC::NamingEntity
		   << '/'
		   << m_imoNumber->toString();
