...
namespace dnv::vista::sdk::test
{
    ...
    TEST( UniversalIdTests, BuildUniversalId_Programmatic )
    {
        ...
        auto localIdBuilder =
            LocalIdBuilder::create( VisVersion::v3_4a )
                .withPrimaryItem( GmodPath::fromShortPath( "621.21/S90", VisVersion::v3_4a ).value() )
                .withSecondaryItem( GmodPath::fromShortPath( "411.1/C101", VisVersion::v3_4a ).value() )
    ...
    {
        auto builder =
            UniversalIdBuilder::create( VisVersion::v3_4a )
                .withLocalId( LocalIdBuilder::create( VisVersion::v3_4a )
                                  .withPrimaryItem( GmodPath::fromShortPath( "411.1", VisVersion::v3_4a ).value() ) );
