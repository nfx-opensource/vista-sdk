...
#include <SDK/internal/versioning/GmodVersioning.h>
...
namespace dnv::vista::sdk::test
{
    ...
    class ConvertPath : public ::testing::TestWithParam<ConvertPathTestData>
    {
    };

    TEST_P( ConvertPath, ConvertPath )
    {
        ...
        auto sourcePath = GmodPath::fromShortPath( params.inputPath, sourceGmod, sourceLocations, sourceErrors );
        ASSERT_TRUE( sourcePath.has_value() )
            << "Failed to parse source path: " << params.inputPath << "\nErrors: " << sourceErrors.toString();

        auto parsedTargetPath =
            GmodPath::fromShortPath( params.expectedPath, targetGmod, targetLocations, targetErrors );
        ASSERT_TRUE( parsedTargetPath.has_value() )
            << "Failed to parse expected path: " << params.expectedPath << "\nErrors: " << targetErrors.toString();

        auto targetPath = vis.convertPath( params.sourceVersion, *sourcePath, params.targetVersion );

        ASSERT_TRUE( targetPath.has_value() ) << "Failed to convert path from " << params.inputPath << " (v"
                                              << VisVersions::toString( params.sourceVersion ) << ") to v"
                                              << VisVersions::toString( params.targetVersion );
    ...
    INSTANTIATE_TEST_SUITE_P(
        ...
        ::testing::Values(
            ...
            ConvertPathTestData{
                "511.11/C101.663i/C663.5/CS6d", "511.11/C101.663i/C663.6/CS6d", VisVersion::v3_4a, VisVersion::v3_6a },
            ConvertPathTestData{ "511.11-1/C101.663i/C663.5/CS6d",
                                 "511.11-1/C101.663i/C663.6/CS6d",
                                 VisVersion::v3_4a,
                                 VisVersion::v3_6a },
            ConvertPathTestData{ "1012.21/C1147.221/C1051.7/C101.22",
                                 "1012.21/C1147.221/C1051.7/C101.93",
                                 VisVersion::v3_4a,
                                 VisVersion::v3_6a },
            ConvertPathTestData{ "1012.21/C1147.221/C1051.7/C101.61/S203.6",
            ...
            ConvertPathTestData{ "1012.21/C1147.221/C1051.7/C101.61/S203.6/S61",
                                 "1012.21/C1147.221/C1051.7/C101.311/C467.5/S61",
                                 VisVersion::v3_4a,
                                 VisVersion::v3_6a },
            ConvertPathTestData{ "000a", "000a", VisVersion::v3_4a, VisVersion::v3_6a },
            ConvertPathTestData{ "1012.21/C1147.221/C1051.7/C101.61/S203.2/S101",
                                 "1012.21/C1147.221/C1051.7/C101.61/S203.3/S110.1/S101",
                                 VisVersion::v3_4a,
                                 VisVersion::v3_6a },
            ConvertPathTestData{ "1012.21/C1147.221/C1051.7/C101.661i/C624",
                                 "1012.21/C1147.221/C1051.7/C101.661i/C621",
                                 VisVersion::v3_4a,
                                 VisVersion::v3_6a },
            // ConvertPathTestData{ "1012.22/S201.1/C151.2/S110.2/C101.61/S203.2/S101",
            // "1012.22/S201.1/C151.2/S110.2/C101.61/S203.3/S110.1/S101", VisVersion::v3_4a, VisVersion::v3_6a }, //
            // Parent code change and different depth, which introduced cycle
            ConvertPathTestData{ "1012.22/S201.1/C151.2/S110.2/C101.64i",
                                 "1012.22/S201.1/C151.2/S110.2/C101.64",
                                 VisVersion::v3_4a,
                                 VisVersion::v3_6a },
            ConvertPathTestData{ "632.32i/S110.2/C111.42/G203.31/S90.5/C401",
                                 "632.32i/S110.2/C111.42/G203.31/S90.5/C401",
                                 VisVersion::v3_4a,
                                 VisVersion::v3_6a },
            ConvertPathTestData{ "864.11/G71.21/C101.64i/S201.1/C151.31/S110.2/C111.42/G204.41/S90.2/S51",
                                 "864.11/G71.21/C101.64/S201.1/C151.31/S110.2/C111.42/G204.41/S90.2/S51",
                                 VisVersion::v3_4a,
                                 VisVersion::v3_6a },
            ConvertPathTestData{ "864.11/G71.21/C101.64i/S201.1/C151.31/S110.2/C111.41/G240.1/G242.2/S90.5/C401",
            ...
            // ConvertPathTestData{ "354.2/C1096", "354.2/C1096", VisVersion::v3_4a, VisVersion::v3_6a }, // Was
            // deleted, as path to root is gone
            ConvertPathTestData{ "514/E15", "514", VisVersion::v3_4a, VisVersion::v3_6a },
            ConvertPathTestData{ "1346/S201.1/C151.31/S110.2/C111.1/C109.16/C509",
                                 "1346/S201.1/C151.31/S110.2/C111.1/C109.126/C509",
                                 VisVersion::v3_7a,
                                 VisVersion::v3_8a }
            // ConvertPathTestData{ "851/H231", "851", VisVersion::v3_6a, VisVersion::v3_7a } // Effect of SD - no idea
            // how to version this
            ) );
    ...
    class ConvertFullPath : public ::testing::TestWithParam<ConvertFullPathTestData>
    {
    };

    TEST_P( ConvertFullPath, ConvertFullPath )
    {
        const auto& params = GetParam();
        const auto& vis = VIS::instance();
        ...
        auto sourcePath = GmodPath::fromFullPath( params.inputPath, sourceGmod, sourceLocations, sourceErrors );
        ASSERT_TRUE( sourcePath.has_value() )
            << "Failed to parse source path: " << params.inputPath << "\nErrors: " << sourceErrors.toString();

        auto parsedTargetPath =
            GmodPath::fromFullPath( params.expectedPath, targetGmod, targetLocations, targetErrors );
        ASSERT_TRUE( parsedTargetPath.has_value() )
            << "Failed to parse expected path: " << params.expectedPath << "\nErrors: " << targetErrors.toString();
    ...
    INSTANTIATE_TEST_SUITE_P(
        GmodVersioningTests,
        ConvertFullPath,
        ::testing::Values( ConvertFullPathTestData{ "VE/600a/630/632/632.3/632.32/632.32i-2/S110",
    ...
    class ConvertNode : public ::testing::TestWithParam<ConvertNodeTestData>
    {
    };

    TEST_P( ConvertNode, ConvertNode )
    {
        const auto& params = GetParam();
        const auto& vis = VIS::instance();
    ...
    class ConvertLocalId : public ::testing::TestWithParam<ConvertLocalIdTestData>
    {
    };

    TEST_P( ConvertLocalId, ConvertLocalId )
    {
        const auto& params = GetParam();
        const auto& vis = VIS::instance();
    ...
    INSTANTIATE_TEST_SUITE_P(
        ...
        ConvertLocalId,
        ::testing::Values(
            ConvertLocalIdTestData{ "/dnv-v2/vis-3-4a/411.1/C101/sec/411.1/C101.64i/S201/meta/cnt-condensate",
    ...
    class ValidPathToLatest : public ::testing::TestWithParam<GmodPathTestItem>
    {
    };

    TEST_P( ValidPathToLatest, Valid_GmodPath_To_Latest )
    {
        const auto& params = GetParam();
        const auto& vis = VIS::instance();
        ...
        ParsingErrors errors;
        auto sourcePath = GmodPath::fromShortPath( params.path, sourceGmod, sourceLocations, errors );
    ...
    INSTANTIATE_TEST_SUITE_P( GmodVersioningTests, ValidPathToLatest, ::testing::ValuesIn( LoadValidGmodPaths() ) );
    ...
    TEST( GmodVersioningTests, ConvertGmodPathWithLocation )
    {
        ...
        auto sourcePath = GmodPath::fromShortPath( "691.811i-A/H101.11-1", sourceGmod, sourceLocations, sourceErrors );
        ASSERT_TRUE( sourcePath.has_value() );
