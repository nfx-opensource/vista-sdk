...
int main()
{
    ...
    //=====================================================================
    {
        ...
        auto query = MetadataTagsQueryBuilder::empty().withTag( CodebookName::Quantity, "temperature" ).build();
    ...
    //=====================================================================
    {
        ...
        if( node411Opt.has_value() && nodeC101Opt.has_value() )
        {
            ...
            auto query = GmodPathQueryBuilder::empty().withNode( *node411, true ).withNode( *nodeC101, true ).build();
            ...
            auto path3 = GmodPath::fromShortPath( "412.1/C101.31", gmod, locations );
            ...
            std::cout << "  Matches: " << std::boolalpha << ( path3 ? query.match( *path3 ) : false )
    ...
    //=====================================================================
    {
        ...
        auto query = LocalIdQueryBuilder::empty().withPrimaryItem( pathQuery ).build();
    ...
    //=====================================================================
    {
        ...
        if( node411Opt.has_value() && nodeC101Opt.has_value() )
        {
            ...
            // Build path query
            auto pathQuery =
                GmodPathQueryBuilder::empty().withNode( *node411, true ).withNode( *nodeC101, true ).build();

            // Build tags query
            auto tagsQuery = MetadataTagsQueryBuilder::empty().withTag( CodebookName::Quantity, "temperature" ).build();

            // Combine in LocalIdQuery
            auto query = LocalIdQueryBuilder::empty().withPrimaryItem( pathQuery ).withTags( tagsQuery ).build();
    ...
    //=====================================================================
    {
        ...
        auto query1 = LocalIdQueryBuilder::empty().withoutSecondaryItem().build();
    ...
    //=====================================================================
    {
        ...
        if( node411Opt.has_value() && nodeC101Opt.has_value() )
        {
            ...
            const auto baseNodes = GmodPathQueryBuilder::empty().withNode( *node411, true ).withNode( *nodeC101, true );

            // Build final query using const& copy (demonstrates reusability)
            auto query = LocalIdQueryBuilder::empty().withPrimaryItem( baseNodes.build() ).build();
