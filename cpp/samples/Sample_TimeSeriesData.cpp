...
int main()
{
    ...
    //=====================================================================
    {
        ...
        std::cout << "  Time Range    : " << header.timeRange()->start().toString() << " - "
                  << header.timeRange()->end().toString() << "\n";
    ...
    //=====================================================================
    {
        ...
        auto shipId = ShipId::fromString( "IMO9074729" ).value();
        auto timeRange =
            timeseries::TimeRange{ DateTimeOffset{ "2024-12-30T10:00:00Z" }, DateTimeOffset{ "2024-12-30T14:00:00Z" } };
    ...
    //=====================================================================
    {
        ...
        if( docOpt.has_value() )
        {
            timeseries::TimeSeriesDataPackage deserializedPackage{ timeseries::Package{
                std::nullopt, std::vector<timeseries::TimeSeriesData>{} } };

            nfx::serialization::json::SerializationTraits<timeseries::TimeSeriesDataPackage>::deserialize(
