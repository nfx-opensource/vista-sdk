...
int main()
{
	...
	//=====================================================================
	{
		...
		for ( const auto& locStr : validLocations )
		{
			...
			std::cout << "  '" << locStr << "'" << std::string( 6 - locStr.length() + 1, ' ' ) << "-> ";
	...
	//=====================================================================
	{
		...
		std::cout << "  " << std::left << "Number      :" << ( builder.number().has_value() ? std::to_string( builder.number().value() ) : "none" ) << "\n";
		std::cout << "  " << std::left << "Side        :" << ( builder.side().has_value() ? std::string( 1, builder.side().value() ) : "none" ) << "\n";
		std::cout << "  " << std::left << "Vertical    :" << ( builder.vertical().has_value() ? std::string( 1, builder.vertical().value() ) : "none" ) << "\n";
		std::cout << "  " << std::left << "Transverse  :" << ( builder.transverse().has_value() ? std::string( 1, builder.transverse().value() ) : "none" ) << "\n";
		std::cout << "  " << std::left << "Longitudinal:" << ( builder.longitudinal().has_value() ? std::string( 1, builder.longitudinal().value() ) : "none" ) << "\n\n";
	}
