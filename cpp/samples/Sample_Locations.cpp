...
int main()
{
    ...
    //=====================================================================
    {
        ...
        auto builder = LocationBuilder::create( locations ).withNumber( 1 ).withSide( 'P' ).withVertical( 'U' );
    ...
    //=====================================================================
    {
        ...
        std::cout << "  " << std::left << "Side        :"
                  << ( builder.side().has_value() ? std::string( 1, builder.side().value() ) : "none" ) << "\n";
