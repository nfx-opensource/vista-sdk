...
int main()
{
	...
	//=====================================================================
	{
		...
		std::cout << "Quantity codebook has " << std::setw( 3 ) << quantity.standardValues().size() << " standard values\n";
		std::cout << "Position codebook has " << std::setw( 3 ) << position.standardValues().size() << " standard values\n";
	...
	//=====================================================================
	{
		...
		for ( const auto& pos : testPositions )
		{
			...
			std::cout << "  '" << pos << "'" << std::string( 17 - pos.length() + 1, ' ' ) << ": ";
	...
	//=====================================================================
	{
		...
		if ( qtyTag && cntTag && posTag && stateTag )
		{
			...
			std::cout << "Complete path   : " << sb.toString() << "\n";
		}
