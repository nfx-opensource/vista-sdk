...
int main()
{
	...
	//=====================================================================
	{
		...
		customProperties.set( "precision", Decimal{ 0.000001 } );
		auto property = datachannel::Property{
			datachannel::DataChannelType{ "Inst" },
	...
	//=====================================================================
	{
		...
		// Create header
		auto shipId = ShipId::fromString( "IMO9074729" ).value();
		auto configRef = datachannel::ConfigurationReference{ "vessel-config-2024-v1", DateTimeOffset{ "2024-12-30T10:00:00Z" }, "v1" };
		...
		// Channel 3: Engine Temperature
		{
			...
			auto property = datachannel::Property{
				datachannel::DataChannelType{ "Average" },
				datachannel::Format{ "Decimal" },
		...
		for ( size_t i = 0; i < package.dataChannelList().dataChannels().size(); ++i )
		{
			...
			std::cout << "  [" << ( i + 1 ) << "] " << *channel.dataChannelId().shortId()
					  << " (" << channel.property().dataChannelType().type() << ", "
	...
	//=====================================================================
	{
		...
		Value stringValue = Value::String{ "test string" };
		Value intValue = Value::Integer{ 42 };
		Value decimalValue = Value::Decimal{ 3.14159 };
		Value boolValue = Value::Boolean{ true };
		Value dateTimeValue = Value::DateTime{ "2024-12-30T15:30:00Z" };
	...
	//=====================================================================
	{
		...
		std::string json = nfx::serialization::json::Serializer<datachannel::DataChannelListPackage>::toString( dataChannelListPackage, options );
	...
	//=====================================================================
	{
		...
		auto shipId = ShipId::fromString( "IMO9074729" ).value();
		auto configRef = datachannel::ConfigurationReference{ "main-engine-monitor-v3", DateTimeOffset{ "2024-12-30T10:00:00Z" }, "3.0" };
		...
		// Channel 2: Lube Oil Pressure
		{
			...
			auto property = datachannel::Property{
				datachannel::DataChannelType{ "Average", 5.0, 1.0 },
				datachannel::Format{ "Decimal" },
		...
		// Channel 3: Exhaust Gas Temperature
		{
			...
			auto property = datachannel::Property{
				datachannel::DataChannelType{ "Average", 10.0, 10.0 },
				datachannel::Format{ "Decimal" },
		...
		// Channel 4: Fuel Consumption
		{
			...
			auto property = datachannel::Property{
				datachannel::DataChannelType{ "Average", 60.0, 60.0 },
				datachannel::Format{ "Decimal" },
				datachannel::Range{ 0.0, 5000.0 },
				unit,
				"A",
