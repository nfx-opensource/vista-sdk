...
int main()
{
	...
	//=====================================================================
	{
		...
		// Complex full path
		auto path2 = GmodPath::fromFullPath( "VE/600a/610/612/612.2/612.2i-1/612.21-1/CS10/C701/C701.1/C701.13/S93", gmod, locations );
		if ( path2.has_value() )
		{
	...
	//=====================================================================
	{
		...
		auto path = GmodPath::fromFullPath( "VE/600a/610/612/612.2/612.2i-1/612.21-1/CS10/C701/C701.1/C701.13/S93", gmod, locations );
		if ( path.has_value() )
		{
	...
	//=====================================================================
	{
		...
		auto path = GmodPath::fromShortPath( "411i/411.1-1P", gmod, locations );
		if ( path.has_value() )
		{
			...
			auto indPath = GmodPath::fromShortPath( "411i/411.1-1P", gmod, locations );
